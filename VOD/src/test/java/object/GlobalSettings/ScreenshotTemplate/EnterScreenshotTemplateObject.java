...
public class EnterScreenshotTemplateObject extends CommonObject {

    public EnterScreenshotTemplateObject(WebDriver driver) {
        super(driver);
    }

    private static Logger logger = Logger.getLogger(EnterScreenshotTemplateObject.class);
    ...
    @FindBy(xpath = "//aside//a[contains(text(),'截图模板')]")
    public WebElement screenshottemplate;//截图模板
