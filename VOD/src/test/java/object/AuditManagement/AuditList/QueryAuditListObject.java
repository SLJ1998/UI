...
public class QueryAuditListObject extends CommonObject {

    public QueryAuditListObject(WebDriver driver) {
        super(driver);
    }

    private static Logger logger = Logger.getLogger(QueryAuditListObject.class);
