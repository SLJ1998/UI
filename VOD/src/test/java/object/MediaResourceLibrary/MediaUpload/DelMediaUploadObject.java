...
public class DelMediaUploadObject extends CommonObject {

    public DelMediaUploadObject(WebDriver driver) {
        super(driver);
    }

    private static Logger logger = Logger.getLogger(DelMediaUploadObject.class);
