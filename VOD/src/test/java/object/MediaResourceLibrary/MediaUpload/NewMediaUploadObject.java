...
public class NewMediaUploadObject extends CommonObject {

    public NewMediaUploadObject(WebDriver driver) {
        super(driver);
    }

    private static Logger logger = Logger.getLogger(NewMediaUploadObject.class);
