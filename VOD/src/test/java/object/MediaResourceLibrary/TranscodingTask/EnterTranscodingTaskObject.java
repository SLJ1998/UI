...
public class EnterTranscodingTaskObject extends CommonObject {

    public EnterTranscodingTaskObject(WebDriver driver) {
        super(driver);
    }

    private static Logger logger = Logger.getLogger(EnterTranscodingTaskObject.class);
    ...
    @FindBy(xpath = "//aside//a[contains(text(),'转码任务')]")
    public WebElement transcoding;//转码任务界面
