...
public class BatchDelMediaManagementObject extends CommonObject {

    public BatchDelMediaManagementObject(WebDriver driver) {
        super(driver);
    }

    private static Logger logger = Logger.getLogger(BatchDelMediaManagementObject.class);

    //定位元素
    @FindBy(xpath = "//tr/th[1]/span/div/span/label/span[1]")
    public WebElement select;//选择

    @FindBy(xpath = "//div[2]/div/div/div[1]/div[3]/button")
