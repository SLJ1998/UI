...
public class QueryPrefetchObject extends CommonObject {

    public QueryPrefetchObject(WebDriver driver) {
        super(driver);
    }

    private static Logger logger = Logger.getLogger(QueryPrefetchObject.class);

    //定位元素
    @FindBy(xpath = "//*[@id=\"page-main\"]/div/div/div[2]/app-home/distribute-prefetch/nz-tabset/div[1]/div/div/div/div/div[1]/div[2]")
