...
public class EnterDefaultDistributionConfigurationObject extends CommonObject {

    public EnterDefaultDistributionConfigurationObject(WebDriver driver) {
        super(driver);
    }

    private static Logger logger = Logger.getLogger(EnterDefaultDistributionConfigurationObject.class);
    ...
    @FindBy(xpath = "//aside//a[contains(text(),'默认分发配置')]")
    public WebElement distribution;//默认分发配置
